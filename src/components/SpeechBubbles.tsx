...
const SpeechBubblesSlide: React.FC = () => {
    return (
        <div className="w-full h-full bg-[#151515] p-10 flex flex-col border border-white/10 overflow-y-auto rounded-xl shadow-2xl">
            {/* Título Original */}
            <h3 className="text-xl font-bold text-white mb-8">Vamos Conversar?</h3>

            <div className="flex flex-col gap-10">
                {/* BALÃO 1: INICIAR PROJETOS (Conteúdo Original) */}
                ...
                {/* BALÃO 2: ESPECIALIDADES (Conteúdo Original) */}
