...
const CVModal = () => {
    return (
        <div className="w-full max-w-2xl mx-auto h-[550px] shadow-2xl bg-[#151515] rounded-lg overflow-hidden border border-white/10">
            {/* Container de Scroll Snap Nativo (Substitui o Swiper) */}
            <div className="flex overflow-x-auto snap-x snap-mandatory h-full scrollbar-hide">

                {/* LÂMINA 1: PERFIL & CORE STACK */}
                <div className="min-w-full snap-center bg-[#151515] p-10 flex flex-col h-full border-r border-white/10">
                    <div className="mb-6">
                    ...
                    <p className="mt-8 text-gray-400 text-xs leading-relaxed italic border-l-2 border-blue-500/50 pl-4 text-white">
                    ...
                    <div className="mt-auto text-center text-[9px] text-gray-600 uppercase tracking-widest animate-pulse">
                        Deslize para ver experiências →
                    </div>
                </div>

                {/* LÂMINA 2: EXPERIÊNCIA RECENTE */}
                <div className="min-w-full snap-center bg-[#151515] p-10 flex flex-col h-full border-r border-white/10 overflow-y-auto">
                    <h3 className="text-xl font-bold text-white mb-6 underline underline-offset-8 decoration-blue-500/30 text-white">Trajetória Atual</h3>
                ...
                <div className="min-w-full snap-center bg-[#151515] p-10 flex flex-col h-full">
                    ...
                    <div className="mt-auto pt-4 border-t border-white/10 text-center">
                        <p className="text-[10px] text-gray-500 uppercase tracking-widest">Araçoiaba da Serra, SP | Disponível para Projetos Globais</p>
                    </div>
                </div>
