...
const WhatsAppButton: React.FC = () => {
    ...
    return (
        ...
        >
            {/* Container do Ícone com Efeito Premium */}
            <div className="relative flex h-14 w-14 items-center justify-center bg-[#25D366] rounded-full shadow-[0_8px_30px_rgb(37,211,102,0.4)] hover:shadow-[0_8px_40px_rgb(37,211,102,0.6)] transition-all duration-300 hover:-translate-y-1 active:scale-95">
                ...
                <span className="absolute inset-0 rounded-full bg-[#25D366] opacity-20 animate-ping group-hover:hidden"></span>
            </div>

            {/* Label Lateral (Tag de Nome) */}
            <div className="opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 pointer-events-none">
                <div className="bg-white/10 backdrop-blur-md border border-white/20 px-4 py-2 rounded-lg">
                    ...
                    <p className="text-[9px] text-[#25D366] font-medium leading-none">Online Agora</p>
                </div>
            </div>
        </a>
    );
